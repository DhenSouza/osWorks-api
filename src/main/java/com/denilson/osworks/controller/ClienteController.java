package com.denilson.osworks.controller;
...
import com.denilson.osworks.domain.repository.ClienteRepository;
...
public class ClienteController {
	...
	public ResponseEntity<Cliente> findById(@PathVariable Long id) {
		return clienteRepository.findById(id).map(obj -> ResponseEntity.ok(obj))
